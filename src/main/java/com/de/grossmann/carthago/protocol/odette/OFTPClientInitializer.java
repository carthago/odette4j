...
{
    // TODO it's much better to use a protocol enumeration here
    
    // This flag should indicate whether to use 
    // a framer for stream transmission buffer or not
    private boolean useTcpIp = true;
    ...
    public OFTPClientInitializer(final boolean useTcpIp) {
        this.useTcpIp = useTcpIp;
    }
